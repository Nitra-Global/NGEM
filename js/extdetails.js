...
#extensionModal {
    ...
    --bg-lighter: #f9f9f9; /* Noch hellerer Hintergrund für Kontraste */
    --accent-color: #007bff; /* Helleres Blau für den Akzent */
    --text-dark: #333333; /* Dunkler Text */
    --error-color: #d9534f; /* Rot für Fehler */
...
#extensionModal .loading-bar {
    width: 100%;
    height: 4px;
    background-color: var(--bg-lighter); /* Heller Hintergrund für die Ladeleiste */
    border-radius: 20px;
    overflow: hidden;
}
...
#extensionModal .btn-primary {
    background-color: var(--accent-color);
    color: var(--bg-light); /* Weißer Text */
}

#extensionModal .btn-secondary {
    background-color: #e0e0e0; /* Heller Grauton für sekundäre Buttons */
...
#extensionModal .help-text {
    font-size: 0.8em;
    color: #666; /* Mittelgrauer Text */
    text-align: center;
    margin-top: 16px;
}

#extensionModal .info-section {
    background-color: var(--bg-lighter); /* Heller Hintergrund für Infobereich */
    border-radius: 10px;
    padding: 16px;
    margin-top: 16px;
    color: var(--text-dark); /* Dunkler Text */
