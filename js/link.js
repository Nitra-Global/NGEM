...
.custom-popup-overlay {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(255, 255, 255, 0.6); /* Hellere Überlagerung */
    z-index: 9999;
    opacity: 0;
...
.custom-popup-container {
    ...
    border-radius: 12px;
    padding: 25px;
    box-shadow: 0 8px 24px rgba(0, 0, 0, 0.1); /* Dezenter Schatten */
    z-index: 10000;
    max-width: 500px;
    width: 90%;
...
.custom-popup-header {
    font-size: 24px;
    color: #333333; /* Dunkler Header-Text */
    margin-bottom: 20px;
    font-weight: 600;
}
...
.custom-popup-warning {
    font-size: 14px;
    color: #d9534f; /* Rot für Warnungen */
    margin-bottom: 20px;
}
...
.confirm-button {
    background-color: #1a73e8; /* Blau */
    color: #fff;
}

.confirm-button:hover {
    background-color: #0f5cb5; /* Dunklerer Blau-Ton */
}
...
.cancel-button:hover {
    background-color: #e6e6e6; /* Dezente Hover-Farbe */
}
...
.custom-error-close-button {
    ...
    border: none;
    border-radius: 6px;
    background-color: #d9534f; /* Rote Schließen-Schaltfläche */
    color: #fff;
    cursor: pointer;
    font-size: 16px;
    transition: background-color 0.3s ease;
...
.custom-error-close-button:hover {
    background-color: #c9302c; /* Dunklerer Rot-Ton */
}
