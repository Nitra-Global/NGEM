...
.custom-context-overlay {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(255, 255, 255, 0.7); /* Hellere Überlagerung */
    z-index: 9998;
    display: none;
}
...
.custom-context-menu .menu-section {
    padding: 8px 0;
    border-bottom: 1px solid #e0e0e0; /* Dezente Linie */
}
...
.custom-context-menu .menu-item .material-icons {
    margin-right: 12px;
    color: #999; /* Dezente Farbe für Icons */
    font-size: 18px;
}
...
.custom-notification {
    ...
    top: 20px;
    right: 20px;
    background-color: #007bff; /* Akzentfarbe für Benachrichtigungen */
...
.custom-find-highlight {
    background-color: #ffeb3b; /* Hellgelb für Hervorhebungen */
    padding: 2px;
    border-radius: 2px;
}
...
.custom-find-modal input:focus {
    border-color: #007bff; /* Akzentfarbe */
    outline: none;
}
...
.custom-find-modal button {
    ...
    border-radius: 4px;
    cursor: pointer;
    background-color: #007bff; /* Akzentfarbe */
    color: #fff;
...
.custom-find-modal .close-button {
    background-color: #e0e0e0; /* Hellgrauer Button */
}

.custom-find-modal .close-button:hover {
    background-color: #d6d6d6; /* Etwas dunklerer Grauton bei Hover */
}
